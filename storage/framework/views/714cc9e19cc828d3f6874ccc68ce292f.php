...
<body class="bg-gray-900 text-white">
    <header class="bg-black shadow-lg">
        <nav class="container mx-auto px-6 py-3 flex justify-between items-center">
            <a href="/" class="text-3xl font-bold text-white">MK<span class="text-purple-500"> Material</span></a>
            <div class="flex items-center">
                <a href="/login" class="px-4 py-2 text-purple-500 font-semibold hover:text-purple-400 transition duration-300">Login</a>
                <a href="/register" class="ml-4 px-4 py-2 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition duration-300">Register</a>
            </div>
        </nav>
    </header>
    ...
    <main class="container mx-auto px-6 py-16">
        <section class="text-center">
            ...
            <a href="/products" class="px-8 py-3 bg-purple-600 text-white rounded-lg font-semibold text-lg hover:bg-purple-700 transition duration-300">Shop Now</a>
        </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <?php for($i = 1; $i <= 3; $i++): ?>
                    <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition duration-300 hover:shadow-2xl">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYZvmS_ZOqDhGozzFzje3QApokD6RdxI6plw&s" alt="Product Image" class="w-full h-48 object-cover">
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2">Product <?php echo e($i); ?></h3>
                            <p class="text-gray-400 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <div class="flex justify-between items-center">
                                <span class="text-2xl font-bold text-purple-500">$<?php echo e(rand(10, 100)); ?>.99</span>
                                <button
                                            type="button"
...
<?php /**PATH C:\xampp\htdocs\ecommerce-material\resources\views/welcome.blade.php ENDPATH**/ ?>