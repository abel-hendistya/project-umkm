                    ...
                    <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition duration-300 hover:shadow-2xl">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <a href="<?php echo e(route('products.show', $i)); ?>" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition duration-300">View Details</a>
                            </div>
                        </div>
                    </div>
                <?php endfor; ?>
...
<?php /**PATH C:\xampp\htdocs\ecommerce-material\resources\views/home.blade.php ENDPATH**/ ?>