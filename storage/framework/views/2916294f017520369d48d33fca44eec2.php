...
<body class="bg-gray-900 text-white">
    ...
    <header class="bg-black shadow-lg">
        <nav class="container mx-auto px-6 py-3 flex justify-between items-center">
            <a href="<?php echo e(route('home')); ?>" class="text-3xl font-bold text-white">Mitra Karya Material</a>
            <div>
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition duration-300 hover:shadow-2xl">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-400 mb-2">Price: Rp<?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                            <p class="text-gray-400 mb-4">Stock: <?php echo e($product->stock); ?></p>
...
<?php /**PATH C:\xampp\htdocs\ecommerce-material\resources\views/users/dashboard.blade.php ENDPATH**/ ?>