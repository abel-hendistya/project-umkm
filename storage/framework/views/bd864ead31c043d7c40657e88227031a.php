...
<body class="bg-gray-900 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md p-8 space-y-4 bg-gray-800 rounded-lg shadow-lg">
        ...
        <p class="text-center text-sm text-gray-400">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-gray-300 hover:underline">Sign Up</a>
        </p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\ecommerce-material\resources\views/auth/login.blade.php ENDPATH**/ ?>